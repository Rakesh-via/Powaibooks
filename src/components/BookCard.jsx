...
export default function BookCard({ book, index }) {
  return (
    <motion.a
      ...
      className="block overflow-hidden rounded-[28px] bg-white/90 shadow-[0_18px_45px_rgba(56,189,248,0.16)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_24px_55px_rgba(56,189,248,0.22)] focus:outline-none focus:ring-4 focus:ring-brand-200"
    >
      ...
      <div className="space-y-4 p-5">
        ...
        <div className="flex flex-wrap gap-2 text-sm font-medium text-skyPop-700">
          ...
          <span className="inline-flex min-h-[44px] items-center gap-2 rounded-full bg-brand-100 px-3 py-2 text-brand-800">
